class DOMHelper {
	...
	static moveElement(elementId: string, newDestionationSelector: string) {
...
class Component {
	...
	constructor(hostElementId?: string, insertBefore: boolean = false) {
		if (hostElementId) {
...
class Tooltip extends Component {
	constructor(public closeNotifier: () => void) {
		super();
		this.create();
	}
	...
	create() {
		...
		tooltipElement.textContent = "Dynamic Tooltip";
...
class ProjectItem {
	...
	connectMoreInfoButton() {
		...
		const moreInfoButton = projectItemElement.querySelector("button:first-of-type")! as HTMLButtonElement;
