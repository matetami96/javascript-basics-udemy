...
class Validator {
	...
	static validate(
		value: string,
		flag: typeof Validator.REQUIRED | typeof Validator.MIN_LENGTH,
...
class UserInputForm {
	constructor(
		public form = document.getElementById("user-input") as HTMLFormElement,
		public userNameInput = document.getElementById("username") as HTMLInputElement,
		public passwordInput = document.getElementById("password") as HTMLInputElement
	) {
		form.addEventListener("submit", this.signupHandler.bind(this));
	}

	signupHandler(event: SubmitEvent) {
