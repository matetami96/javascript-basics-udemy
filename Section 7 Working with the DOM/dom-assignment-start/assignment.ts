...
// Task 1
const task1El1 = document.getElementById("task-1") as HTMLLIElement;
const task1El2 = document.querySelector("li") as HTMLLIElement;

task1El1.style.color = "white";
task1El2.style.backgroundColor = "black";

// Task 2
const docTitle1 = document.querySelector("title") as HTMLTitleElement;
// docTitle1.textContent = "Assignment - Solved!";

const docHead = document.head;
const docTitle2 = document.head.querySelector("title") as HTMLTitleElement;
