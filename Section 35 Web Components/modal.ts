...
class Modal extends HTMLElement {
    ...
    `;
		...
		const backdrop = this.shadowRoot!.querySelector("#backdrop") as HTMLDivElement;
	...
	attributeChangedCallback(name: string, oldValue: ValueType, newValue: ValueType) {
